...
function Signin() {
  ...
  return (
    <div className='flex h-screen w-full justify-center items-center'>
      <div className='lg:w-[60vw] lg:h-[80vh] w-[80vw] flex justify-center items-center shadow-2xl bg-black rounded-xl max-lg:flex-col shadow-primary'>
        <div className='lg:w-1/3 justify-center bg-primary md:h-[100%] rounded-xl  shadow-2xl h-[10%] w-full hidden'></div>
